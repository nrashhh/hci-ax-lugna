...
/**
 * Api services for the `WebUser` model.
 */
@Injectable()
export class WebUserApi extends BaseLoopBackApi {
  ...
  /**
   * Queries accessTokens of WebUser.
   *
   * @param {any} id WebUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of WebUser.
   *
   * @param {any} id WebUser id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WebUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries notifications of WebUser.
   *
   * @param {any} id WebUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts notifications of WebUser.
   *
   * @param {any} id WebUser id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countNotifications(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WebUsers/:id/notifications/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.WebUser#getCurrent
   * @methodOf sdk.WebUser
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/WebUsers" + "/:id";
   ...
   * call to {@link sdk.WebUser#login} or
   * {@link sdk.WebUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.WebUser#login}
   *
  ...
  /**
   * @name sdk.WebUser#isAuthenticated
   *
